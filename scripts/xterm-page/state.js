  ...
  // Built rather than written as a string escape: a leftover from when this
  // glue lived inside a template literal, kept because every escape-sequence
  // constant in the page derives from it and one spelling beats two.

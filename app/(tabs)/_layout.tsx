 ...
 *
 * The PNGs are generated by `node scripts/buildTabIcons.mjs`, committed, and
 * checked by tests/unit/tabIcons.test.ts.
 */
/*
    ...
    >
      ...
      <NativeTabs.Trigger name="board">
        {/*
          ...
          'original' and strand it in flat lucide black on a dark bar. Naming it
          makes the icon's tinting independent of a prop three elements away.
        */}
        <NativeTabs.Trigger.Icon
          md="view_kanban"
          src={require('../../assets/tab-icons/board-kanban.png')}

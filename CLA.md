# Kangentic Mobile Individual Contributor License Agreement

**Version 1.0, July 2026**

Thank you for your interest in contributing to Kangentic Mobile, a project maintained by VORPAHL LLC ("We" or "Us").
...
**"Contribution"** means any work of authorship, including any modifications or additions to an existing work, that is intentionally submitted by You to Us for inclusion in Kangentic Mobile. "Submitted" means code, documentation, or configuration sent via pull requests or patches on GitHub. For the avoidance of doubt, issues, comments, discussion posts, and other communications that do not contain code or documentation intended for inclusion are not Contributions under this Agreement.
...
You retain copyright and all other rights in Your Contributions. You are free to use Your Contributions in any other project or for any other purpose.
...
By signing this Agreement (via the CLA Assistant bot on GitHub), You accept and agree to the terms and conditions of this Agreement for Your present and future Contributions submitted to Kangentic Mobile.
